...
.. code-block:: bash
    ...
    heroku run python fafadia-intranet/manage.py syncdb --noinput --settings=config.settings
    heroku run python fafadia-intranet/manage.py migrate --settings=config.settings
    heroku run python fafadia-intranet/manage.py collectstatic --settings=config.settings
